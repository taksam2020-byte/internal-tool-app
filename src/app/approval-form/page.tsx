...
export default function ApprovalFormPage() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setValidated(true);
    // This form doesn't submit data, it just prepares for printing.
    // We can add submission logic later if needed.
    event.preventDefault(); 
    alert('入力内容がプレビューに反映されました。印刷またはPDFとして保存してください。');
  };
            ...
            <Card.Body>
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                <div className="d-grid mt-4">
                    <Button type="submit">プレビューに反映</Button>
                </div>
