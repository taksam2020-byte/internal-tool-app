...
function DataManagement() {
    ...
    const proposalYears = Array.from(new Set(applications.filter(a => a.application_type === 'proposal').map(a => JSON.parse(a.details as any).提案年度))).sort((a, b) => b.localeCompare(a));
